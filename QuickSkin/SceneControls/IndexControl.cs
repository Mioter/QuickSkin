...
namespace QuickSkin.SceneControls;
...
public class IndexControl : ItemsControl
{
    ...
    /// 当前显示的内容索引（双向绑定）
    /// </summary>
    public static readonly StyledProperty<int> IndexProperty = AvaloniaProperty.Register<IndexControl, int>(
        nameof(Index),
    ...
    /// 当索引无效时显示的默认内容
    /// </summary>
    public static readonly StyledProperty<object?> DefaultContentProperty = AvaloniaProperty.Register<
        IndexControl,
        object?
